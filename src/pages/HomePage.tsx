              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between border-b pb-8 gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground font-medium">Automatically split into {tweets.length} parts for maximum engagement.</p>
                  </div>
                  <div className="flex flex-wrap gap-3">
                    <Button
                      variant="outline"
                      className="gap-2 h-12 px-6 rounded-xl border-border bg-white font-semibold"
                ...
                <div className="flex justify-center pt-16">
                  <Button
                    ...
                    className="group gap-2 text-muted-foreground hover:text-primary h-12 px-8 rounded-2xl font-semibold transition-all"
                  >
          ...
          {!tweets.length && !isSplitting && (
            ...
            >
              ...
              >
                 ...
                 <Sparkles className="relative w-20 h-20 mx-auto text-blue-500/30" />
              </motion.div>
